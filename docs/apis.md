...
To let an AI assistant answer questions about your אפליקצית חגי data over these apis, point it at [ai-queries.md](ai-queries.md) — it covers the query syntax, the `deliverStatus` codes and the traps that produce wrong answers.
