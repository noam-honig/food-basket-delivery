...
export class donor {
  ...
  assignRequiresADistributionList =
    'לא ניתן לשייך מתנדבים מכיוון שלא נבחרה מעבדה. אנא בחרו מעבדה (למעלה מצד שמאל איפה שכתוב "כל הרשימות")'
  ...
  assignHelpText =
    'אנא הזיני את הטלפון של המתנדב ושמו, ואז תוכלי לבחור קבוצה, עיר ואילו סלים לשייך'
  ...
  existsInRemovedFromListStrategy =
    'מה לעשות אם נמצאה תורם תואמת המסומנת כהוצא מהרשימות'
  organizationInfo = 'פרטי הארגון'
  defaultHelpPhone = 'הטלפון ממנו יצא הSMS'
  defaulyHelpPhoneExplanation =
    'כאשר נשלחת הודעת SMS למתנדב, היא מוצגת כאילו היא יצאה מהטלפון של מי ששייך לו את התורמים ולחץ על הכפתור שלח SMS. ניתן להגדיר כאן שם חלופי וטלפון חלופי'
  smsTextHelpTitle =
    'הודעה זו תשלח למתנדב ממסך שיוך משלוחים - עם הקישור לתורמים להן הוא מתבקש לחלק.'
  ...
  familyAlreadyHasAnActiveDelivery =
    'לתורם זו כבר קיים משלוח מאותו סוג האם להוסיף עוד אחד?'
  notOk = 'לא תקין'
  ...
  freezeDeliveryHelp =
    'משלוח "קפוא" הינו הינו משלוח אשר לא ישוייך לאף מתנדב עד שאותו המשלוח "יופשר". הקפאה משמשת לעצירה זמנית של משלוחים מסויימים עד לשלב בו אפשר להפשיר אותם ולשלוח. האם להקפיא את המשלוח ל'
  ...
  excelNoneOfTheseFamiliesMatch =
    ' אף אחת מהתורמים הללו אינה מתאימה לשורה באקסל, '
  ...
  deleteFamiliesHelp =
    'לחיצה על הכפתור תמחוק את כל התורמים בסטטוס "למחיקה" מהמערכת. היסטורית המשלוחים שלהן תישמרנה.'
  ...
  adminRequireToSetPassword =
    ' אתה מוגדר כמנהל אך לא מוגדרת עבורך סיסמה. כדי להשתמש ביכולות הניהול חובה להגן על הפרטים עם סיסמה. הנך מועבר למסך עדכון פרטים לעדכון סיסמה.'
  ...
  freezeDeliveriesHelp =
    'משלוח "קפוא" הינו הינו משלוח אשר לא ישוייך לאף מתנדב עד שאותו המשלוח "יופשר". הקפאה משמשת לעצירה זמנית של משלוחים מסויימים עד לשלב בו אפשר להפשיר אותם ולשלוח. ההקפאה תתבצע רק למשלוחים שהם מוכנים למשלוח. '
  ...
  updateStatusHelp =
    'סטטוס הוצא מהרשימות - נועד כדי לסמן שהתורם לא אמורה לקבל מזון - אבל בניגוד לסטטוס למחיקה - אנחנו רוצים לשמור אותה בבסיס הנתונים כדי שאם הרווחה יביאו לנו אותה שוב, נדע להגיד שהם הוצאו מהרשימות. זה מתאים לתורמים שחס וחלילה נפטרו או שפשוט לא רוצים לקבל - או שהכתובת לא קיימת וכו...'
  ...
  deleteDeliveriesHelp =
    'שים לב - מחיקת המשלוח לא תוציא את התורם מהרשימות - כדי להוציא את התורם מהרשימות יש לבצע עדכון לסטטוס התורם. המחיקה תתבצע רק עבור משלוחים שטרם נמסרו'
  ...
  updateDeliveriesStatusHelp =
    'סטטוס "מוקפא" הינו הינו משלוח אשר לא ישוייך לאף מתנדב עד שאותו המשלוח "יופשר". הקפאה משמשת לעצירה זמנית של משלוחים מסויימים עד לשלב בו אפשר להפשיר אותם ולשלוח.             ההקפאה תתבצע רק למשלוחים שהם מוכנים למשלוח. '
  statusNotSelected = 'לא נבחר סטטוס'
  updateCanceled = 'העדכון הופסק'
  archiveDeliveries = 'העברה לארכיב'
  archiveDeliveriesHelp =
    'העברה לארכיב תעשה רק למשלוחים שנמסרו או נתקלו בבעיה. ניתן לראות את הארכיב בכל עת במסך היסטורית משלוחים'
  ...
  newDeliveryForDeliveriesHelp =
    'משלוח חדש יוגדר עבור כל המשלוחים המסומנים שהם בסטטוס תרומה נאספה, או בעיה כלשהי, אלא אם תבחרו לסמן את השדה '
  ...
  addressNotOkOpenWaze =
    'הכתובת אינה מדוייקת. בדקו בגוגל או התקשרו לתורם. נשמח אם תעדכנו את הכתובת שמצאתם בהערות. האם לפתוח וייז?'
  ...
  areYouSureYouWantToMarkDeliveredSuccesfullyToAllHelperFamilies =
    'האם אתה בטוח שאתה רוצה לסמן תרומה נאספה ל'
  ...
  enterFirstTime =
    'מכיוון שלא מוגדרת לך סיסמה עדיין - אנא הכנס בפעם הראשונה, על ידי הקלדת מספר הטלפון שלך ללא סיסמה ולחיצה על הכפתור "כניסה". המערכת תבקש שתגדיר סיסמה וזו תהיה סיסמתך.\n  בהצלחה'
  ...
  ifBasketTypeInExcelIsDifferentFromExistingOneCreateNewDelivery =
    'אם קיים משלוח לתורם עם סוג סל שונה, הוסף משלוח חדש'
  ...
  sameLineExcelMatchesSeveralRowsInTheDatabase =
    'אותה תורם באתר מתאימה למספר שורות באקסל: '
  ...
  moreThanOneRowInDbMatchesExcel =
    'נמצאה יותר מתורם אחד באתר המתאימה לשורה הזו מהאקסל. אנא בחר איזו מהתורמים הבאות מתאימה לשורה מהאקסל והעבר אותה לתורמים לעדכון'
  ...
  updateFamilyDefaultsHelp =
    'פעולה זו מאפשרת לעדכן את הברירות מחדל לתורם בהתאם למשלוחים המסומנים. בחרו אילו שדות לעדכן'
  updateBasedOnTheChangesIn = 'האם לעדכנם בהתאם לשינויים ב'
  familyHasExistingDeliveriesDoYouWantToViewThem =
    'לתורם זו יש משלוחים פעילים, האם להציג אותם?'
  and = 'ו'
  ...
  excelImportUpdateFamilyDefaultsBasedOnCurrentDelivery =
    'עדכן ברירות מחדל לתורם בהתאם למשלוח זה'
  ...
  familiesDotCancelTheseAssignments =
    'תורמים. האם לבטל אותו כברירת מחדל לתורמים אלו?'
  editComment = 'ערוך הערה'
  createNewEvent = 'פתיחת ארוע חדש'
  createNewEventHelp =
    'פעולה זו מעבירה את המשלוחים הפעילים לארכיון, ומאפשר פתיחת משלוח חדש לתורמים'
  ...
  notDoneDeliveriesShouldArchiveThem =
    'משלוחים שטרם שוייכו, האם להעביר אותם לארכיב?'
  ...
  includeFamilyInfoInExcelFile =
    'האם לכלול מידע נוסף מפרטי התורם כגון מספר זהות ונתונים נוספים ביצוא לאקסל? (אם כן זה יקח יותר זמן:)'
  ...
  MaxDeliverisQuantityThatAnIndependentVolunteerCanAssignHimself =
    'כמות מוצרים מקסימלית שמתנדב עצמאי יכול לשייך לעצמו '
