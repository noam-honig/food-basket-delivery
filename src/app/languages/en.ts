...
export class en {
  ...
  askVolunteerForLocationOnDelivery = 'Ask the volunteer to update a location when handing over the basket';
  askVolunteerForAPhotoToHelp = 'Ask the volunteer for a picture that will help the next volunteer';
  questionForVolunteerWhenUploadingPhoto = 'What to write to a volunteer when you want a picture';
  defaultQuestionForVolunteerWhenUploadingPhoto = 'Attach a photo to help the next volunteer';
  ...
  save_photo_and_display_to_next_volunteer = 'Save and present to the next volunteer';
