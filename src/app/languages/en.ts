...
export class en {
  ...
  commentForSuccessLeft =
    'Please specify where you left the parcel and with whom you spoke'
  commentForProblem = 'Kindly describe your experience'
  messageForDoneDelivery =
    "Thanks for all the help, we'd love to volunteer again"
  ...
  markAllDeliveriesAsSuccesfull =
    'Mark "successfully delivered" to all deliveries'
  ...
  assignRequiresADistributionList =
    'Please select a distribution list (from the selection box at the top right corner) before assigning deliveries.'
  findHelperByName = 'Search by Name'
  clearHelperInfo = 'Clear volunteer details'
  saveHelperInfoAndMoveToNextHelper =
    'Save volunteer details and go to the next volunteer'
  ...
  assignHelpText =
    "Please type volunteer's phone and name to start delivery assignment, you can also search volunteer by name, by clicking on "
  asignVideoHelp =
    'For a tutorial on delivery assignment and distribution event click here'
  ...
  transferDeliveriesFromOtherVolunteer =
    'Transfer families from another volunteer'
  ...
  passwordDoesntMatchConfirmPassword =
  ...
  messageForVolunteerWhenDoneCaption =
    'Notification to volunteer when all families are finished'
  ...
  showText1OnlyWhenDone =
    'Display free text 1 only when the volunteer has finished all parcels'
  freeText2ForVolunteer = 'Free text 2 for volunteer'
  urlFreeText2 = 'Free volunteer text URL 2 for volunteer'
  showText2OnlyWhenDone =
    'Display free text 2 only when the volunteer has finished all parcels'
  enableSelfPickupModule = 'Enable Self Pickup module'
  enableLabReception = 'Delivery ends after absorption in the laboratory'
  showVolunteerCompany =
    'Save on behalf of which company the volunteer came from'
  ...
  filterCityHelp = 'Show only volunteers distributed in the city'
  ...
  defaultPhonePrefixForExcelImport =
    'Default phone prefix for import from Excel'
  checkIfFamilyExistsInDb = 'Check if a family already exists in the database'
  checkIfFamilyExistsInFile =
    'Check if a family already exists in the Excel file'
  excelImportAutoAddValues =
    'Add values to the infrastructure tables without asking'
  ...
  RemovedFromListExcelImportStrategy_showInUpdate =
    'View in families for update'
  RemovedFromListExcelImportStrategy_ignore = 'Ignore and add a new family'
  existsInRemovedFromListStrategy =
    'What to do if a matching family is found to be excluded from the lists'
  organizationInfo = 'Organization details'
  defaultHelpPhone = 'Help Phone Name'
  defaulyHelpPhoneExplanation =
    'By default, the person who assigned the delivery, will be the person that the volunteer can call for help. Specify a different value here, if you prefer another help phone number'
  smsTextHelpTitle =
    'This message will be sent to a volunteer from the Assign Volunteer screen - with the link to the families it is asked to share.'
  ...
  familyAlreadyHasAnActiveDelivery =
    'This family already has delivery of the same type.'
  notOk = 'Invalid'
  ...
  freezeDeliveryHelp =
    '"Frozen" delivery is a delivery that will not be assigned with any volunteer until the "delivery" is dispatched. Freezing is used to temporarily stop certain deliveries until they can be thawed and shipped. Do freeze delivery to'
  ...
  sendSmsToAllVolunteersThatDidntGetOne =
    'Send an SMS to volunteers who have not yet received'
  completed = 'Completed'
  ...
  drawingHelpText =
    'Please click on the map at several points to highlight the area you want, and double-click to finish'
  ...
  excelNoneOfTheseFamiliesMatch =
    'None of these families fit in the line at Excel,'
  ...
  reminderSmsTextHelp =
    'This message will be sent to a volunteer who is delayed from a volunteer tracking screen'
  sampleReminderSms = 'Sample reminder message'
  registerFamilyReplyEmailText =
    'This message will be sent to the donor after registering for the system'
  registerHelperReplyEmailText =
    'This message will be sent to the volunteer after registering for the system'
  basketTypes = 'Parcel types'
  distributionLists = 'Distribution lists'
  familySources = 'Family Sources'
  distributionListsHelp =
    'These groups will be presented with family affiliation and will allow for quick filtering'
  volunteerTexts = 'Volunteer messages'
  volunteerQAndA = 'Volunteer questions and answers'
  volunteerQAndAHelp =
    'When the volunteer presses the "I have a problem" button, a screen appears with this list of FAQs for help'
  question = 'a question'
  answer = 'Answer'
  voluntreeHelpPhones = 'Phones for volunteer help'
  volunteerHelpPhonesHelpLine1 =
    'When the volunteer presses the "I have a problem" button, a screen will appear if you can call for help or update without giving a message.'
  volunteerHelpPhonesHelpLine2 =
    'Here you can update which phones will show him help, you can update one or more.'
  preferences = 'Preferences'
  logoAndIcons = 'Logos and figurines'
  logoRecommendTool = 'We recommend using the icons'
  logoRecommendAfter =
    'And the result it creates using favicon.ico for the icon - and in apple-icon-120x120.png for the logo'
  iconForWebSite = 'Website Icon'
  logoForWebsiteAndPhone = 'Website and phone logos'
  deleteFamilies = 'Delete families'
  deleteFamiliesHelp =
    'Clicking this button will delete all families in the "delete" status from the system. Their delivery history will be preserved.'
  ...
  moreNews = 'More news'
  filter = 'filtering'
  deliveryDetailsAsDisplayedToVolunteer =
    'Family details as they appear to the volunteer'
  assign = 'Assign'
  ...
  confirm = 'Confirm'
  displayFamilyAsVolunteerWillSeeIt =
    'View a family as a volunteer will see her'
  ...
  badAddressHelpLine1 =
    "Please compare the 'Address' field with the 'Address on  Google Maps' field."
  badAddressHelpLine2 =
    'Note that an inaccurate address may cause the volunteer to navigate to a completely different place.'
  ...
  adminRequireToSetPassword =
    'You are a manager user without a required password defined. Please set a password in the following user details screen.'
  indieRequireToSetPassword =
    'An independent volunteer is required to enter the system with a password'
  ...
  freezeDeliveriesHelp =
    '"Frozen" delivery is a delivery that will not be assigned with any volunteer until the "delivery" is dispatched. Freezing is used to temporarily stop certain deliveries until they can be thawed and shipped. The freeze will only be carried out for deliveries that are ready for delivery.'
  unfreezeDeliveries = 'Cancellation of delivery free'
  unfreezeDeliveriesHelp =
    'Canceling the freeze will return frozen deliveries ready for delivery'
  ...
  selfpickupStrategy_byCurrentDelivery =
    'Self Pickup according to the current delivery'
  ...
  deleteDeliveriesHelp =
    'Deleting undelivered deliveries only. Please note that recipient families are not removed from distribution lists. To remove a family from the lists you should update the family status.'
  ...
  updateVolunteerHelp =
    'To update a volunteer on the way to "ready to ship", select "Unsubscribe from a volunteer". In any case, a volunteer update will only be made to unpublished deliveries'
  updateVolunteer = 'Update volunteer shipper'
  updateDeliveriesStatus = 'Update delivery status'
  updateDeliveriesStatusHelp =
    'The status of "frozen" is a delivery that will not be assigned with any volunteer until the delivery is "enabled". Freezing is used to temporarily stop certain deliveries until they can be thawed and shipped. The freeze will only be carried out for deliveries that are ready for delivery.'
  ...
  archiveDeliveriesHelp =
    "Only deliveries marked as 'delivered' or 'failed' are archived . The archive can be viewed at any time under delivery History."
  ...
  newDeliveryForAll =
    'New delivery for all deliveries and not just for those that ended successfully'
  ...
  newDeliveryForDeliveriesHelp =
    'A new delivery will be set for all statuses that have been successfully delivered, or any problem, unless you choose to select the field'
  volunteerByFamilyDefault =
    'Set up a volunteer by default family-defined volunteer'
  ...
  addressNotOkOpenWaze =
    'The address is inaccurate. Please check Google Maps or call family and kindly update the correct address in the comments section. Would you like to open Maps?'
  wasCopiedSuccefully = ' Successfully copied'
  areYouSureYouWantToCancelAssignmentTo =
    'Are you sure you want to cancel assignment to'
  cancelAssignmentForHelperFamilies =
    'Cancel all deliveries assigned to volunteer'
  areYouSureYouWantToMarkDeliveredSuccesfullyToAllHelperFamilies =
    'Are you sure you want to mark successfully delivered to'
  ...
  clearAllVolunteerCommentsAreYouSure =
    'Are you sure you want to clear all volunteer comments?'
  clearEscortInfo = 'Clear escort details for all volunteers'
  clearEscortInfoAreYouSure =
    'Are you sure you want to clear escort details for all volunteers?'
  ...
  enterFirstTime =
    'Because you do not have a password set yet - please enter for the first time, by typing in your phone number without a password and clicking the "Login" button. The system will ask you to set a password and that will be your password.\n  Successfully'
  ...
  updateOfAddressMayTakeLonger =
    'Note - Updating an address field can take longer than other fields'
  ...
  defineDeliveriesForFamiliesInExcel =
    'Define deliveries for all families imported from Excel file'
  ifBasketTypeInExcelIsDifferentFromExistingOneCreateNewDelivery =
    'If there is a delivery for a family with a different parcel type, add a new one'
  ...
  sameLineExcelMatchesSeveralRowsInTheDatabase =
    'The same family on the site fits several lines in Excel:'
  manyAddressesEndWithNumber =
    'From the addresses are empty or ending in the book - you may not have noticed the settlement of the address. Go back to column definition?'
  moreThanOneRowInDbMatchesExcel =
    'More than one family was found on the site corresponding to this line from Excel. Please select which of the following families fits the row from the excel and pass it on'
  familyAlreadyRemovedFromList =
    'Updated family in database as removed from lists'
  ...
  smsLoginFailed =
    "Something didn't work out with the link, you are taken to a login screen - please enter with your phone number"
  ...
  volunteerCanUpdateDeliveryComment =
    'A volunteer can update a note for delivery'
  volunteerCanUpdatePreferredDistributionAddress =
    'A volunteer can update a preferred division area'
  email = 'eMail'
  ...
  showDistCenterAsEndAddressForVolunteer =
    'View distribution list addresses as a volunteer endpoint'
  endOnFar = 'End at the farthest Address'
  startAtDistributionCenterAndEndOnRemoteFamily =
    'End at the most isolated address'
  ...
  deliveries_ShouldWeDeleteThem =
    'Active Deliveries, do you want to Delete them?'
  ...
  updateFamilyDefaultsHelp =
    'Update family defaults based on current delivery. Please select which columns to update'
  updateBasedOnTheChangesIn = ', update them based on changes in'
  familyHasExistingDeliveriesDoYouWantToViewThem =
    'This family has active deliveries, display them?'
  and = 'and'
  ...
  excelImportUpdateFamilyDefaultsBasedOnCurrentDelivery =
    'Update family defaults according to this delivery'
  ...
  registerAskPreferredDistributionAreaAddress =
    'Request a distribution area address when registering'
  ...
  showOnlyLastNamePartToVolunteer =
    'Show just one last word to the volunteer on behalf of the family'
  ...
  sessionExpiredPleaseRelogin =
    'The connection to the server has expired, please log in again'
  setAsDefaultVolunteerForTheseFamilies =
    'Save as a default volunteer for these families'
  thisVolunteerIsSetAsTheDefaultFor =
    'This volunteer is defined as a default volunteer for more'
  familiesDotCancelTheseAssignments =
    'Families. Should it be canceled by default for these families?'
  editComment = 'Make a note'
  createNewEvent = 'Create a new event'
  createNewEventHelp =
    'This action will archive all active deliveries, and help create new deliveries'
  ...
  notDoneDeliveriesShouldArchiveThem =
    'Unassigned deliveries, proceed with creating a new event?'
  deliveresOnTheWayAssignedInTheLast3Hours =
    'Deliveries that were assigned in the last 3 hours and were not delivered yet, proceed with opening a new event?'
  ...
  includeFamilyInfoInExcelFile =
    'Should include additional family information such as ID number and additional export data to Excel? (If so it will take longer :)'
  ...
  codeWord = 'Code word'
  toConfirmPleaseTypeTheCodeWord =
    'To confirm the deletion, please type the code word'
  deleted = 'Deleted'
  ...
  showDeliverySummaryToVolunteerOnFirstSignIn =
    'View a delivery summary for a volunteer at first entry'
  MaxItemsQuantityInDeliveryThatAnIndependentVolunteerCanSee =
    'Maximum quantity of products in delivery that an independent volunteer can see'
  MaxDeliverisQuantityThatAnIndependentVolunteerCanAssignHimself =
    'Maximum amount of deliveries that an independent volunteer can assign to himself'
  printVolunteers = 'Print volunteers'
  buildingCode = 'Building code'
  sendWhats = 'Send WhatsApp'
  assignBuildings = 'Selection of buildings'
  askVolunteerForLocationOnDelivery =
    'Ask the volunteer to update a location when handing over the basket'
  askVolunteerForAPhotoToHelp =
    'Ask the volunteer for a picture that will help the next volunteer'
  questionForVolunteerWhenUploadingPhoto =
    'What to write to a volunteer when you want a picture'
  defaultQuestionForVolunteerWhenUploadingPhoto =
    'Attach a photo to help the next volunteer'
  deletePhoto = 'Delete image'
  numOfPhotos = 'Several photos taken by the volunteer'
  photos_taken_by_volunteer = 'Pictures taken by the volunteer'
  save_photo_and_display_to_next_volunteer =
    'Save and present to the next volunteer'
  volunteerOpportunities = 'Volunteering opportunities'
  add = 'Add'
  ...
  later = 'Later'
  past = 'Moved'
  canceled = 'Canceled participation'
  cancelUser = 'User opt-out'
  cancelDate = 'Date of cancellation of participation'
  lastUpdate = 'Update date'
  fromGeneralList = 'Registered through the general list'
  donotShowEventsInGeneralList =
    'Do not present volunteering opportunities in the list of all organizations'
  ...
  dragDeliveriesToChangeTheirOrder =
    'You can now drag the shipments to change their order'
  youVeRegisteredTo = 'You signed up for'
  thanksForVolunteering =
    '. Thank you for volunteering and willingness to help!'
  registerHelpText =
    'Thanks for the volunteer spirit !!! Type in your name and phone number and this is it - you are registered to volunteer :)'
  ...
  sendMessageToInviteVolunteers = 'Sending a message to summon volunteers'
  whatToTake = 'bring'
  previewVolunteerScreen = 'The volunteer display model'
  fullAddress = 'full address'
  fieldProperties = 'Field properties'
  fontSize = 'Font size'
  centerAlign = 'Straighten to the center'
  color = 'Color'
  textBefore = 'Text before'
  textAfter = 'Text after'
  sameLine = 'In the same line'
  bold = 'emphasis'
  pageProperties = 'Page Features'
  labelProperties = 'Sticker Features'
  height = 'height'
  width = 'width'
  leftPadding = 'Left margin'
  rightPadding = 'Right margin'
  topPadding = 'Upper margin'
  bottomPadding = 'Lower margin'
  newPageForEachVolunteer = 'New page for every volunteer'
  ...
  allowVolunteerToSeePreviousActivities =
    'Allow the volunteer to see historical activities'
  ...
  emailForVolunteerRegistrationNotification =
    'Email for notification when a volunteer signs up'
  ...
  defaultDeliveryStatusIsEnquireDetails =
    'Clarify details as default status for shipments'
  ...
  descriptionInOrganizationList =
    'Description in the general list of organizations'
