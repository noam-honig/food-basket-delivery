...
export class es {
  ...
  filterCityHelp = 'Mostrar solo voluntarios distribuidos en la ciudad';
  ...
  doNotSendSms = 'No envíes SMS grupales en absoluto';
  ...
  preferredDistributionAreaAddress = 'Dirección del área de distribución';
  preferredDistributionAreaAddressCity = 'Ciudad a área de subdivisión';
  preferredFinishAddress = 'Dirección para finalizar la ruta';
  preferredFinishAddressCity = 'Ciudad para finalizar la ruta';
  ...
  askVolunteerForLocationOnDelivery = 'Pídale al voluntario que actualice una ubicación al entregar la canasta';
  askVolunteerForAPhotoToHelp = 'Pídale al voluntario una foto que ayude al próximo voluntario';
  questionForVolunteerWhenUploadingPhoto = 'Qué escribirle a un voluntario cuando quieres una foto';
  defaultQuestionForVolunteerWhenUploadingPhoto = 'Adjunte una foto para ayudar al próximo voluntario';
  deletePhoto = 'Eliminar Imagen';
  numOfPhotos = 'Varias fotos tomadas por el voluntario';
  photos_taken_by_volunteer = 'Fotografías tomadas por el voluntario';
  save_photo_and_display_to_next_volunteer = 'Guardar y presentar al próximo voluntario';
  ...
  later = 'Luego';
  past = 'Movido';
  canceled = 'Participación cancelada';
  cancelUser = 'Exclusión del usuario';
  cancelDate = 'Fecha de cancelación de participación';
  ...
  smsProviderConfiguration = 'Configuración del proveedor de SMS';
  sendMessageToInviteVolunteers = 'Envío de un mensaje para convocar voluntarios';
  whatToTake = 'traer';
  previewVolunteerScreen = 'El modelo de exhibición de voluntarios';
  fullAddress = 'dirección completa';
  fieldProperties = 'Propiedades de campo';
  fontSize = 'Tamaño de fuente';
  centerAlign = 'Enderezar al centro';
  color = 'Color';
  textBefore = 'Texto antes';
  textAfter = 'Texto después';
  sameLine = 'en la misma línea';
  bold = 'énfasis';
  pageProperties = 'Características de la página';
  labelProperties = 'Características de la etiqueta';
  height = 'altura';
  width = 'ancho';
  leftPadding = 'Margen izquierdo';
  rightPadding = 'Margen derecho';
  topPadding = 'Margen superior';
  bottomPadding = 'margen inferior';
  newPageForEachVolunteer = 'Nueva página para cada voluntario';
  columnProperties = 'Propiedades de columna';
  ...
  stickerProperties = 'Características de la etiqueta';
  showOnlyIncoming = 'Mostrar solo los mensajes entrantes';
  incoming = 'estas entrando';
  addHistoricalDelivery = 'Añadir envío histórico';
  allowVolunteerToSeePreviousActivities = 'Permitir que el voluntario vea actividades históricas';
  ...
  emailForVolunteerRegistrationNotification = 'Correo electrónico para recibir notificaciones cuando un voluntario se registre';
  sendTestEmail = '¿Enviar un correo electrónico para revisión?';
  hasRegisteredTo = 'solicitar';
  thatWillTakePlaceAt = 'Para celebrarse en';
  hasCanceledRegistration = 'Participación cancelada en';
  navigate = 'Ir';
  contact = 'contacto';
  dial = 'Llamada';
  whatsApp = 'WhatsApp';
  fullList = 'Lista llena';
  usingCallModule = 'Activa un módulo telefónico para conocer los detalles';
  enquireDetails = 'Aclaración de detalles';
  waitingForAdmin = 'esperando al gerente';
  caller = 'Teléfono';
  callerComment = 'nota telefonica';
  callerAssignDate = 'Fecha de asociación del teléfono';
  callCounter = 'intentos de llamar';
  defaultDeliveryStatusIsEnquireDetails = 'Aclarar detalles como estado predeterminado para envíos';
