...
export class soldier implements Language {
  ...
  prioritizeRepeatFamilies = 'עדיפות לחיילים חוזרים';
  ...
  confirm = 'אשר';
  displayFamilyAsVolunteerWillSeeIt = 'הצג חייל כפי שתנדב יראה אותה';
  ...
  updateStatusHelp = 'סטטוס הוצא מהרשימות - נועד כדי לסמן שהחייל לא אמורה לקבל מזון - אבל בניגוד לסטטוס למחיקה - אנחנו רוצים לשמור אותה בבסיס הנתונים כדי שאם הרווחה יביאו לנו אותה שוב, נדע להגיד שהם הוצאו מהרשימות. זה מתאים לחיילים שחס וחלילה נפתרו או שפשוט לא רוצים לקבל - או שהכתובת לא קיימת וכו...';
