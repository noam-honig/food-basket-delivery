...
export class soldier {
  ...
  existsInRemovedFromListStrategy =
    'מה לעשות אם נמצאה חייל תואמת המסומנת כהוצא מהרשימות'
  organizationInfo = 'פרטי הארגון'
  defaultHelpPhone = 'טלפון לעזרה למתנדב'
  defaulyHelpPhoneExplanation =
    'כאשר המתנדב נתקל בבעיה, מוצגת לו האפשרות להתקשר לעזרה. כברירת מחדל הטלפון לעזרה הוא זה של המשתמש ששייך למתנדב את החייל. ניתן להגדיר שם וטלפון חלופיים לעזרה:'
  smsTextHelpTitle =
    'הודעה זו תשלח למתנדב ממסך שיוך משלוחים - עם הקישור לחיילים להן הוא מתבקש לחלק.'
  ...
  familyAlreadyHasAnActiveDelivery =
    'לחייל זו כבר קיים משלוח מאותו סוג האם להוסיף עוד אחד?'
  notOk = 'לא תקין'
  ...
  excelNoneOfTheseFamiliesMatch =
    ' אף אחת מהחיילים הללו אינה מתאימה לשורה באקסל, '
  ...
  deleteFamiliesHelp =
    'לחיצה על הכפתור תמחוק את כל החיילים בסטטוס "למחיקה" מהמערכת. היסטורית המשלוחים שלהן תישמרנה.'
  ...
  updateStatusHelp =
    'סטטוס הוצא מהרשימות - נועד כדי לסמן שהחייל לא אמורה לקבל מזון - אבל בניגוד לסטטוס למחיקה - אנחנו רוצים לשמור אותה בבסיס הנתונים כדי שאם הרווחה יביאו לנו אותה שוב, נדע להגיד שהם הוצאו מהרשימות. זה מתאים לחיילים שחס וחלילה נפטרו או שפשוט לא רוצים לקבל - או שהכתובת לא קיימת וכו...'
  ...
  deleteDeliveriesHelp =
    'שים לב - מחיקת המשלוח לא תוציא את החייל מהרשימות - כדי להוציא את החייל מהרשימות יש לבצע עדכון לסטטוס החייל. המחיקה תתבצע רק עבור משלוחים שטרם נמסרו'
  ...
  addressNotOkOpenWaze =
    'הכתובת אינה מדוייקת. בדקו בגוגל או התקשרו לחייל. נשמח אם תעדכנו את הכתובת שמצאתם בהערות. האם לפתוח וייז?'
  ...
  ifBasketTypeInExcelIsDifferentFromExistingOneCreateNewDelivery =
    'אם קיים משלוח לחייל עם סוג סל שונה, הוסף משלוח חדש'
  ...
  sameLineExcelMatchesSeveralRowsInTheDatabase =
    'אותה חייל באתר מתאימה למספר שורות באקסל: '
  ...
  moreThanOneRowInDbMatchesExcel =
    'נמצאה יותר מחייל אחד באתר המתאימה לשורה הזו מהאקסל. אנא בחר איזו מהחיילים הבאות מתאימה לשורה מהאקסל והעבר אותה לחיילים לעדכון'
  ...
  updateFamilyDefaultsHelp =
    'פעולה זו מאפשרת לעדכן את הברירות מחדל לחייל בהתאם למשלוחים המסומנים. בחרו אילו שדות לעדכן'
  updateBasedOnTheChangesIn = 'האם לעדכנם בהתאם לשינויים ב'
  familyHasExistingDeliveriesDoYouWantToViewThem =
    'לחייל זו יש משלוחים פעילים, האם להציג אותם?'
  and = 'ו'
  ...
  excelImportUpdateFamilyDefaultsBasedOnCurrentDelivery =
    'עדכן ברירות מחדל לחייל בהתאם למשלוח זה'
  ...
  familiesDotCancelTheseAssignments =
    'חיילים. האם לבטל אותו כברירת מחדל לחיילים אלו?'
  editComment = 'ערוך הערה'
  createNewEvent = 'פתיחת חלוקה חדש'
  createNewEventHelp =
    'פעולה זו מעבירה את המשלוחים הפעילים לארכיון, ומאפשרת יצירת משלוח חדש לחיילים'
  ...
  notDoneDeliveriesShouldArchiveThem =
    'משלוחים פעילים שטרם שוייכו, יש למחוק אותם לפני פתיחת חלוקה חדש כדי שלא ישמרו סתם בארכיון.'
  ...
  includeFamilyInfoInExcelFile =
    'האם לכלול מידע נוסף מפרטי החייל כגון מספר זהות ונתונים נוספים ביצוא לאקסל? (אם כן זה יקח יותר זמן:)'
