...
} from '../shipment-assign-screen/shipment-assign-screen.controller'
...
export class VolunteerCrossAssignComponent implements OnInit {
  ...
  private sortList() {
    this.helpers.sort((a, b) => {
      ...
      if (compareFamilies != 0) return compareFamilies
            ...
            if (!helper.problemFamilies[family.id]) {
              ...
              if (d < 5) {
                ...
                helper.relevantFamilies.sort((a, b) => {
                  return (
                    calcAffectiveDistance(a.distance, a.family.totalItems) -
                    calcAffectiveDistance(b.distance, b.family.totalItems)
                  )
                })
              }
            }
