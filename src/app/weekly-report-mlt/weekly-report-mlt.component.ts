...
export class WeeklyReportMltComponent implements OnInit {
  ...
  async refresh() {
    ...
    this.totalPerBasket = await WeeklyReportMltController.getEquipmentStatusTotals(this.dateRange.$.fromDate.inputValue, this.dateRange.$.toDate.inputValue);
    ...
    this.volData = await WeeklyReportMltController.getVolunteersData(this.dateRange.$.fromDate.inputValue, this.dateRange.$.toDate.inputValue);
    this.donorsData = await WeeklyReportMltController.getDonorsData(this.dateRange.$.fromDate.inputValue, this.dateRange.$.toDate.inputValue);
    ...
    this.avgFamiliesPerVolunteer = await WeeklyReportMltController.getVolunteerAverage(this.dateRange.$.fromDate.inputValue, this.dateRange.$.toDate.inputValue);
  }
